...
export default function App() {
  ...
  async function handleDel(id){ const nb=bookings.filter(b=>b.id!==id); setBookings(nb); await saveBookings(nb); setDelId(null); showToast("Eliminata"); setView("calendar"); }
